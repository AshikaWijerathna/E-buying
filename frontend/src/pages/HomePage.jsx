...
const HomePage = () => {
  const categories = [
    ...
    {href:"/frocks",name:"Frocks", imageUrl:"/frocks.avif"}
  ];
  ...
  return (
    <div className='relative min-h-screen text-white overflow-hidden'>
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        <h1 className='text-center text-5xl sm:text-5xl font-bold text-[#0096FF] mb-4'>
        ...
        <div>
          {/* display featured products only when data is loaded */}
